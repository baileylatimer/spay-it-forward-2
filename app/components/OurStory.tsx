  ...
  return (
    <section ref={sectionRef} className="max-w-6xl mx-auto px-4 py-16 relative">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="pr-8">
          <h2 ref={headingRef} className="text-5xl mb-8 font-serif opacity-0">
            From Sonni&apos;s Pet Pantry to Spay It Forward
          </h2>
          <div ref={textRef} className="space-y-6 text-lg opacity-0">
        ...
        <div className="relative h-[600px]">
          <div ref={image1Ref} className="absolute -left-8 top-8 z-10 opacity-0">
            <img 
              src={cats6Url} 
              alt="Cat with Santa hat" 
              className="rounded-xl shadow-lg w-full max-w-[320px]"
            />
          </div>
          <div ref={image2Ref} className="absolute -right-8 top-32 z-20 opacity-0">
            <img 
              src={cats5Url} 
